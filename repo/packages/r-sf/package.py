...
class RSf(RPackage):
    ...
    depends_on('r-units@0.7-0:', when='@1.0-0:', type=('build', 'run')) # OW
    depends_on('r-rcpp@0.12.18:', type=('build', 'run'))
    depends_on('gdal@2.0.1:')
    depends_on('geos@3.4.0:')
    depends_on('proj@4.8.0:5', when='@:0.7-3')
    depends_on('proj@4.8.0:6', when='@0.7-4:0.9') # OW
    depends_on('proj@8.0.0:', when='@1.0:') # OW
    depends_on('sqlite', when='@0.9-7')
    depends_on('r-s2', when='@1.0-0:') # OW
