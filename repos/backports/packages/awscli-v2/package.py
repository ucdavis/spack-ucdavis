...
class AwscliV2(PythonPackage):
    ...
    depends_on("py-flit-core@3.7.1:3.8.0", type=("build", "run"))
    ...
    depends_on("py-ruamel-yaml-clib@0.2:0.2.7", when="^python@:3.9", type=("build", "run"))
    depends_on("py-prompt-toolkit@3.0.24:3.0.38", type=("build", "run"))
    depends_on("py-distro@1.5:1.8", type=("build", "run"))
    depends_on("py-awscrt@0.16.4:0.16.16", when="@2.13", type=("build", "run"))
    depends_on("py-awscrt@0.19.18:0.19.19", when="@2.15", type=("build", "run"))
    depends_on("py-python-dateutil@2.1:2.8.2", type=("build", "run"))
