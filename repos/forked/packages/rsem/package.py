...
class Rsem(MakefilePackage):
    ...
    # rsem vendors samtools v1.3, which is not compatible with zlib-ng, which gets pulled in from
    # bowtie dependencies. see: https://github.com/samtools/htslib/issues/1257
