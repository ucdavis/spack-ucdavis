...
class Npm(Package):
    ...
    version("10.9.0", sha256="c12def16fe3efdc80b1e652d60903d807ac4b78b9e7c3e76f633f4b13a32897c")
    version("9.8.1", sha256="0f3e2ae9569291274114b765d8d79b644f63fa162497daee54446d9a600e0f79")
    ...
    def install(self, spec, prefix):
        ...
        npm_flags = ["bin/npm-cli.js", "install", "-ddd", "--global", f"--prefix={prefix}"]
        with when("@9.8.1:"):
            # Counterintuitively, this means COPY the node_modules from . instead of linking
            # See https://github.com/npm/cli/issues/4031
            npm_flags.append("--install-links")
        node(*npm_flags, ".")
