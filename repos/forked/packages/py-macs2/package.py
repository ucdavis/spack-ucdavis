...
class PyMacs2(PythonPackage):
    ...
    version("2.2.9.1", sha256="8d56bc37fb823fc6387d78138ce968405c54a0a8cd9776682705fd0983252d16")
    ...
    depends_on("python@3.7:3.11", when="@2.2.9.1", type=("build", "run"))
    ...
    depends_on("py-numpy@1.17:", when="@2.2.4:2.2.8", type=("build", "run"))
    depends_on("py-numpy@1.19:", when="@2.2.9.1:", type=("build", "run"))
    depends_on("py-cython@0.29.24:0.29.36", when="@2.2.8:", type="build")
    depends_on("py-cython@0.29:0.29.36", when="@2.2.4:2.2.7.1", type="build")
