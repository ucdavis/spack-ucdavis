...
#
# HPCCF: fix netcff-cxx4 depedency reference
...
class Vtk(CMakePackage):
    ...
    # HPCCF: bring in https://github.com/spack/spack/pull/48737
        ...
        if spec.satisfies("@8.2.0"):
            ...
            cmake_args.extend(
                [
                    ...
                    "-DNETCDF_CXX_LIBRARY={0}".format(spec["netcdf-cxx"].prefix.lib),
                ]
            )
