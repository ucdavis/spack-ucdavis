...
class Lmod(AutotoolsPackage):
    ...
    version("8.7.14", sha256="f1ee222c345f9842a0295ef4728d774b08c6f505ed12cc4a34182b779f571512")
    ...
    variant("modulepath_root",
            default="PREFIX/lmod",
            values=any,
            description="Set the value of MODULEPATH_ROOT in the init files."
    )
    ...
    def configure_args(self):
        ...
        modulepath_root = self.spec.variants["modulepath_root"].value
        if modulepath_root != "PREFIX/lmod":
            args.append("--with-module-root-path={0}".format(modulepath_root))
