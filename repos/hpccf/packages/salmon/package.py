...
class Salmon(CMakePackage):
    ...
    version("1.10.1", sha256="babd9ccc189cfea07566d8a11d047f25fad5b446b4b69257bc6ad8869f8b7707")
    ...
    depends_on("htscodecs@1.5.0:", when="@1.10.1:")
    ...
    resources = [
        (
            "1.10.1",
            "pufferfish",
            "cf2a007f3817c1087abd4170db70e6b3c04aa24babecf92a2d9d2eb7784b6021",
        ),
        (
            "1.9.0",
            "pufferfish",
