...
class Awscli(PythonPackage):
    ...
    depends_on("py-argparse@1.1:", when="^python@:2.7,3.0:3.1", type=("build", "run"))
    depends_on("py-pyyaml@3.10:3.13", when="^python@:2.7,3.0:3.3", type=("build", "run"))
    depends_on("py-pyyaml@3.10:5.2", when="^python@3.4:", type=("build", "run"))
    depends_on("py-colorama@0.2.5:0.3.9", when="^python@:2.7,3.0:3.3", type=("build", "run"))
