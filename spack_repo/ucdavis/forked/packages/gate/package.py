...
class Gate(CMakePackage):
    ...
    depends_on("geant4@:10.5~threads", when="@8.2")  # Gate needs a non-threaded geant4
    ...
    patch("cluster_tools_jobsplitter_platform.patch", when="@9.0:")
    patch("slurm-support-v8.2.patch", when="@8.2")
