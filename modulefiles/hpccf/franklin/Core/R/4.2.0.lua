-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-02-16 09:24:14.017742
--
...
setenv("R_VIEW_HOME", "/share/apps/spack/environments/r-stack/views/4.2.0")
...
prepend_path("R_LIBS", "/share/apps/spack/Rlibs/4.2.0")
