-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-07-18 08:43:41.027001
--
-- relion@4.0.1%gcc@11.3.0+allow_ctf_in_sagd+cuda+double~double-gpu~external_motioncor2~gpu_delay+gui~ipo+mklfft build_system=cmake build_type=RelWithDebInfo cuda_arch=75 purpose=cluster arch=linux-ubuntu22.04-x86_64_v3/kfjahtb
--
...
prepend_path("PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-4.0.1-kfjahtbijo3c2yznejgtveqff3xzup2p/./bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-4.0.1-kfjahtbijo3c2yznejgtveqff3xzup2p/./", ":")
...
setenv("RELION_ROOT", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-4.0.1-kfjahtbijo3c2yznejgtveqff3xzup2p")
