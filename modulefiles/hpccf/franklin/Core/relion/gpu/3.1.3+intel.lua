-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-07-18 08:43:40.243247
--
-- relion@3.1.3%gcc@11.3.0+allow_ctf_in_sagd+cuda+double~double-gpu~external_motioncor2~gpu_delay+gui~ipo+mklfft build_system=cmake build_type=RelWithDebInfo cuda_arch=75 purpose=cluster arch=linux-ubuntu22.04-x86_64_v3/pi2fw26
--
...
prepend_path("PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-3.1.3-pi2fw26s6qu5w5lsqnk7myfnbshtlwgl/./bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-3.1.3-pi2fw26s6qu5w5lsqnk7myfnbshtlwgl/./", ":")
...
setenv("RELION_ROOT", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-3.1.3-pi2fw26s6qu5w5lsqnk7myfnbshtlwgl")
