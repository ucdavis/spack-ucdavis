-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-07-18 08:43:41.140294
--
-- relion@4.0.1%gcc@11.3.0+allow_ctf_in_sagd+cuda+double~double-gpu~external_motioncor2+gpu_delay+gui~ipo+mklfft build_system=cmake build_type=RelWithDebInfo cuda_arch=75 patches=21b9c2c purpose=cluster arch=linux-ubuntu22.04-x86_64_v3/dlfu6ex
--
...
prepend_path("PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-4.0.1-dlfu6exkrotawwjennrheqaiyowaj4aw/./bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-4.0.1-dlfu6exkrotawwjennrheqaiyowaj4aw/./", ":")
...
setenv("RELION_ROOT", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64_v3/gcc-11.3.0/relion-4.0.1-dlfu6exkrotawwjennrheqaiyowaj4aw")
setenv("RELION_QSUB_TEMPLATE", "/share/apps/spack/templates/hpccf/franklin/relion.4.0.1.gpu.x86_64_v3.slurm.template.sh")
