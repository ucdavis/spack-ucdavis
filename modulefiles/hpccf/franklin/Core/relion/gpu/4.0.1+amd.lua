-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-07-18 08:43:40.885340
--
-- relion@4.0.1%gcc@11.3.0+allow_ctf_in_sagd+cuda+double~double-gpu~external_motioncor2~gpu_delay+gui~ipo~mklfft build_system=cmake build_type=RelWithDebInfo cuda_arch=75 purpose=cluster arch=linux-ubuntu22.04-zen2/w3alyek
--
...
prepend_path("LD_LIBRARY_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-4.0.1-w3alyek2h3hvoz47qi3be2summn33rwo/lib", ":")
prepend_path("PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-4.0.1-w3alyek2h3hvoz47qi3be2summn33rwo/./bin", ":")
prepend_path("PKG_CONFIG_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-4.0.1-w3alyek2h3hvoz47qi3be2summn33rwo/./lib/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-4.0.1-w3alyek2h3hvoz47qi3be2summn33rwo/./", ":")
...
setenv("RELION_ROOT", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-4.0.1-w3alyek2h3hvoz47qi3be2summn33rwo")
