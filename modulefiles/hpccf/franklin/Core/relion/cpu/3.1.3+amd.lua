-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-07-18 08:43:39.075317
--
-- relion@3.1.3%gcc@11.3.0+allow_ctf_in_sagd+altcpu~cuda+double~double-gpu~external_motioncor2~gpu_delay+gui~ipo~mklfft build_system=cmake build_type=RelWithDebInfo purpose=cluster arch=linux-ubuntu22.04-zen2/fitiovk
--
...
prepend_path("LD_LIBRARY_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-3.1.3-fitiovk2htizf4s3nm3izfbmmtedauh3/lib", ":")
prepend_path("PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-3.1.3-fitiovk2htizf4s3nm3izfbmmtedauh3/./bin", ":")
prepend_path("PKG_CONFIG_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-3.1.3-fitiovk2htizf4s3nm3izfbmmtedauh3/./lib/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-3.1.3-fitiovk2htizf4s3nm3izfbmmtedauh3/./", ":")
...
setenv("RELION_ROOT", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-zen2/gcc-11.3.0/relion-3.1.3-fitiovk2htizf4s3nm3izfbmmtedauh3")
setenv("RELION_QSUB_TEMPLATE", "/share/apps/spack/templates/hpccf/franklin/relion.3.1.3.cpu.slurm.template.sh")
