-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-01-18 10:54:06.376740
--
...
whatis([[Short description : The MEME Suite allows the biologist to discover novel motifs in collections of unaligned nucleotide or protein sequences, and to perform a wide variety of other motif-based analyses.]])

help([[The MEME Suite allows the biologist to discover novel motifs in
...
prepend_path("PYTHONPATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64/gcc-9.5.0/libxml2-2.10.2-xdb2rwm2g7umzblsmsgrsw4nnrrpgrn4/lib/python3.9/site-packages", ":")
prepend_path("PYTHONPATH", "/share/apps/spack/spack-v0.19/opt/spack/linux-ubuntu22.04-x86_64/gcc-9.5.0/libxslt-1.1.33-s62whotfob7fxsyyjq74aalfyra5fc33/lib/python3.9/site-packages", ":")
